...
export default function Amazon({navigation}) {
  ...
  <Image
      style={styles.Logo}
      source={{
        uri: "https://logowik.com/content/uploads/images/amazon6707.jpg",
      }}
    />
  </View>
  <View style={styles.separacion}></View>
    <Text style={styles.text}>  Amazon Inc. 🗳 </Text>
    <Text style={styles.text1}>  $720.520 </Text>
    ...
    <Image
      ...
      source={{
        uri: "https://live.staticflickr.com/65535/53728190031_892d306318_c.jpg",
      }}
    />
    </View>
